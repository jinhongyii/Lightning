...
public class Type extends Value {
    ...
    public enum TypeID {
        Int32,Int1,Int8,Typetype,LabelType,FunctionType,StructType,PointerType,ArrayType,VoidType
    }
    public static IntType TheInt64 =new IntType("int64",TypeID.Int32);
